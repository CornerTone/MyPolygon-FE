...
/**
 * `<NaN>` ('칭찬일기-상세')
 * - [Open in Figma](https://figma.com/file/NlD9D8mc0GTNdluwALGs8v?node-id=110:787)
 * - [Open in Grida](https://code.grida.co/files/NlD9D8mc0GTNdluwALGs8v?node=110:787)
 *
 *
 * ---
 * @example
 ...
 * ---
 * @preview
 * ![](https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/76a5f96e-9df2-4ae9-9d9d-e11f43b0e1b9)
 * ---
 * @remarks
 ...
 * <!-- grida.meta.widget_declaration | engine : 0.0.1 | source : figma://NlD9D8mc0GTNdluwALGs8v/110:787 -->
 */
